...
public class MetricsHandler {
	...
	public int									buy, sell, buylevel, selllevel, info, infoxp, infolevel, send, grand, bottle, toolinfo, repair, tpto,
			tpme, xpShopSignBuy, xpShopSignSell, xpShopSafeGet, xpShopSafeStore = 0;
	...
	public int calculateSafeQuantity() {
		int a = 0;
		for (Iterator<String> iterator = Safe.values().iterator(); iterator.hasNext();) {
			iterator.next();
			a++;
		}
		return a;
